...
$$
\begin{align*}
(\frac{3}{8}x+4)^2 &= (\frac{3}{8})^2 \cdot x^2 &+& 2 \cdot \frac{3}{8}x \cdot 4 &+& 4^2 \\[.5em]
&=\frac{9}{64}x^2 &+& 3x &+& 16
\end{align*}
$$
...
&=\frac{130}{260} \cdot \frac{51}{17} \\[.5em]
&=\frac{13}{26} \cdot \frac{51}{17} \\[.5em]
...
&=\frac{(x+y) \cdot yx}{y \cdot (x^2-y^2)} \\[.5em]
&=\frac{x \cdot (x+y)}{(x-y)(x+y)} \\[.5em]
&=\frac{x}{x-y}
\end{align*}
$$
