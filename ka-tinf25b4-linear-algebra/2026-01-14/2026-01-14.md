...
Seien $A$, $B$, $C$ Teilmengen eienr Grundmenge $M$, dann gelten folgende Gesetzt:
...
zuzeigen $(A \cao B)^C = A^C \cup B^C$ für $A,B \subseteq M$
...
Im Gegenteil zu Mengen macht die Reihenfolge der Elemente beim kartesischen Produkt einen Utnerschied. 

TODO: dieses Thema verstehen - nochmal anschauen
...
TODO: ist die formel hier drüber richtig abgeschrieben?
...
$f: \mathbb{R} \rightarrowtail \mathbb{R}, x \rightarrowtail x^2$
