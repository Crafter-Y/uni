...
public class SpeedyQuiz {
	...
	public static List<Question> loadQuestions(){
		...
		try {
			URL url = SpeedyQuiz.class.getResource("/speedy/questions.txt");
			...
			JOptionPane.showMessageDialog(null, "questions.txt " + e.getMessage(), "Error loading questions", JOptionPane.ERROR_MESSAGE);
		}
